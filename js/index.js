...
let total = quantidadeAdiquirida * preçoDaUnidade
...
if(quantidadeAdiquirida <=5){
    ...
    console.log{`
    <strong>
   O cliente recebeu um desconto de 2% ${nomeDoProduto}.<br>
    ...
    console.log{`
    <strong>
     O cliente recebeu um desconto de 3% ${nomeDoProduto}.<br>
    valor da compra : ${total}
    total a se pagar(com o desconto): ${preçoTotal}
    </strong>
    `}
    ...
    console.log{`
    <strong>
     O cliente recebeu um desconto de 5%${nomeDoProduto}.<br>
    valor da compra : ${total}
    total a se pagar(com o desconto): ${preçoTotal}
    </strong>
    `}
...
}else if(cod >= 2 && codigo <=4){
    alert("Alimento perecível")

}else if(cod >= 5 && codigo <=6){
    alert("Vestuário")
...
//QUESTÃO 10
/*console.log("<strong> Ordem descrescente: </strong>")
